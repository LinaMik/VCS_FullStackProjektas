...
<div class="container">
    ...
    <div id="admin-add-div" class="hide-form">
        <?php
        ...
        // if (isset($_POST["table-name"]) && !empty($_POST["table-name"])) {
            ...
            $sql = "SELECT column_name FROM information_schema.columns
            WHERE table_schema = 'servisas' and table_name = 'parameters'";
            $result = mysqli_query($conn, $sql);
    ...
    <!-- Forma iraso parodymui -->
    <div id="admin-list-div" class="hide-form">
        <?php
        // echo "gauta: ".$_POST["table-name"];
        ...
        // if (isset($_POST["table-name"]) && !empty($_POST["table-name"])) {
            ...
            // $sql = "SELECT column_name FROM information_schema.columns
            // WHERE table_schema = 'servisas' and table_name = 'parameters'";
            $sql = "SELECT * from table_name = 'parameters'";
            $result = mysqli_query($conn, $sql);
